              ...
              <Form.Group className="mb-3" controlId="newProject.projectName">
                ...
                >
                  <Form.Control
                    ...
                    onChange={(e) => {
                      this.props.setProject((previous) => ({
                        ...previous,
                        name: e.target.value,
                      }));
                    }}
                ...
                <Form.Group as={Col} controlId="newProject.repositoryOwner">
                  ...
                  >
                    <Form.Control
                      ...
                      value={this.props.project.github.repo_owner}
                      onChange={(e) => {
                        this.props.setProject((previous) => ({
                          ...previous,
                          github: {
                ...
                <Form.Group as={Col} controlId="newProject.repositoryName">
                  ...
                  >
                    <Form.Control
                      ...
                      value={this.props.project.github.repo_name}
                      onChange={(e) => {
                        this.props.setProject((previous) => ({
                          ...previous,
                          github: {
          ...
          <Form>
              ...
              <Row>
                <Col sm={6}>
                  ...
                  <Form.Control
                    ...
                    value={this.props.project.token.total_supply}
                      ...
                      onChange={(e) => {
                        ...
                        this.props.setProject((previous) => ({
                          ...
                          token: {
                            ...
                            maintainer_supply:
                              (e.target.value / 100) *
                              this.props.project.token.total_supply,
                          },
                        }));
                      }}
                    />
            ...
            >
              ...
              <Col sm={6}>
                <Card className="card-content">
                  <h2>
                    {this.props.project.token.maintainer_supply.toLocaleString(
                      "en"
                    )}{" "}
                  </h2>
                    ...
                    <Tab.Content>
                      <Tab.Pane eventKey="first">
                        ...
                        <Row>
                          ...
                          <Col sm={9}>
                            <p>{this.props.project.github.repo_owner}</p>
                          </Col>
                        </Row>
                        <Row>
                          <Col sm={3}>
                          ...
                          <Col sm={9}>
                            <p>{this.props.project.github.repo_name}</p>
                          </Col>
                        </Row>
                        <Row>
                          <Col sm={3}>
                      ...
                      <Tab.Pane eventKey="second">
                        ...
                        <Row>
                          ...
                          <Col sm={9}>
                            <p>{this.props.project.token.total_supply}</p>
                          </Col>
                        </Row>
                        <Row>
                          <Col sm={3}>
                          ...
                          <Col sm={9}>
                            <p>{this.props.project.token.maintainer_supply}</p>
                          </Col>
                        </Row>
                      </Tab.Pane>
                    </Tab.Content>
